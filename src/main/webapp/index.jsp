...
<html>
    ...
    <body>
        <div class="login-page">
            <div class="form">
                <p>Serviço CALCULATOR-CLIENT no ar! <br/>
                Use "wsimport -keep  -d . http://localhost:8080/calculator/Calculator?wsdl" para gerar o cliente
                </p>
            </div>
        </div>
    </body>
