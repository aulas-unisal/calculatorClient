 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://jetherrodrigues.com/jaxws/calculator", wsdlLocation = "http://localhost:8080/calculator/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://jetherrodrigues.com/jaxws/calculator", "CalculatorService");
    ...
    public Calculable getCalculatorServicePort() {
        return super.getPort(new QName("http://jetherrodrigues.com/jaxws/calculator", "CalculatorServicePort"), Calculable.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorServicePort")
    public Calculable getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jetherrodrigues.com/jaxws/calculator", "CalculatorServicePort"), Calculable.class, features);
    }
